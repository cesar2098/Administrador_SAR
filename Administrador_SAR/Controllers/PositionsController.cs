...
namespace Administrador_SAR.Controllers
{
    public class PositionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Description,IsActive")] Position position)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Description,IsActive")] Position position)
        {
            if (ModelState.IsValid)
            {
